...
class IllegalSiteDetector:
    ...
    def _build_single_tab(self, parent):
        ...
        ctk.CTkLabel(parent, textvariable=self.single_status, font=self.f_small,
                     text_color=TXT_SEC).pack(anchor="w", padx=PAD_X + 4, pady=(2, 4))
        ...
        try:
            while True:
                ...
                if msg == "single_done":
                    ...
                    self.verdict_sub.configure(text=str(data), text_color=TXT_PRI)
